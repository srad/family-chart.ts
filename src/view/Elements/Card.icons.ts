...
export function userSvgIcon() {
  return svgWrapper(userIcon());
}

export function userEditSvgIcon() {
  return svgWrapper(userEditIcon());
}

export function userPlusSvgIcon() {
  return svgWrapper(userPlusIcon());
}

export function userPlusCloseSvgIcon() {
...
export function pencilSvgIcon() {
  return svgWrapper(pencilIcon());
}

export function pencilOffSvgIcon() {
...
export function historyBackSvgIcon() {
  return svgWrapper(historyBackIcon());
}

export function historyForwardSvgIcon() {
  return svgWrapper(historyForwardIcon());
}

export function personSvgIcon() {
  return svgWrapper(personIcon(), "0 0 512 512");
}

export function miniTreeSvgIcon() {
